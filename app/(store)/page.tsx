...
export const metadata: Metadata = {
  ...
  description:
    "Móveis, interiores e marcenaria sob medida desenhados para uma vida com menos ruído e mais presença.",
  openGraph: {
    ...
    images: [
      {
        url: "/images/noma/living-room.webp",
        width: 1672,
        height: 941,
        alt: "Interior contemporâneo Noma",
      },
    ],
  },
  twitter: {
    ...
    title: "Noma — Móveis & Interiores",
    description: "Design que habita o seu tempo.",
    images: ["/images/noma/living-room.webp"],
  },
};
      ...
      <section className={styles.productsSection} id="colecao-produtos">
        <div className={styles.shell}>
          <div className={styles.productsHeading} data-reveal>
            <div>
              <p className={styles.kicker}>Loja Noma</p>
              <h2>Produtos em destaque</h2>
              <p className={styles.productsSubhead}>
                Peças selecionadas do catálogo com preço, categoria e disponibilidade em um só lugar.
              </p>
            </div>
            <Link href="/buscar" className={styles.roundLink} aria-label="Ver todos os produtos">
          ...
          <div className={styles.storeProductGrid} data-home-product-count={products.length}>
            {products.map((product, index) => {
              ...
              return (
                ...
                >
                  <Link href={`/produto/${product.slug}`} aria-label={`Ver ${product.title}`}>
                    <div
          ...
          {showCategoryRail && (
            <nav className={styles.categoryRail} aria-label="Atalhos do catálogo" data-reveal>
              <Link href="/buscar?sort=relevance">Mais vendidos</Link>
      ...
      <section className={styles.manifesto} id="sobre">
        <div className={styles.shell}>
          <div className={styles.manifestoTop} data-reveal>
            <p className={styles.kicker}>Nossa forma de pensar</p>
            <span>São Paulo · desde 2008</span>
          </div>
          <div className={styles.manifestoGrid}>
            ...
            <div className={styles.manifestoCopy} data-reveal>
              <p>
                Da escala da arquitetura ao toque do tecido, cada escolha existe para tornar a casa mais
                intuitiva, serena e verdadeiramente sua.
              </p>
              <Link href="#inspiracao" className={styles.textLink}>
                Conheça nosso olhar <ArrowRight aria-hidden="true" size={16} />
              </Link>
            </div>
          </div>
        </div>
      ...
      <section className={styles.roomsSection} id="ambientes">
        <div className={styles.shell}>
          <div className={styles.sectionHeader} data-reveal>
            <div>
              <p className={styles.kicker}>Explore por ambiente</p>
              <h2>Uma casa inteira,<br />uma só linguagem.</h2>
            </div>
            <p>
              Peças essenciais, proporções generosas e materiais naturais conectam cada espaço sem repetir
              fórmulas.
            </p>
          </div>
      ...
      <section className={styles.collectionsSection} id="colecoes">
        <div className={styles.shell}>
          <div className={styles.collectionIntro} data-reveal>
            <p className={styles.kicker}>Coleções</p>
            <h2>Quatro coleções. Um sistema completo.</h2>
            <p>Volumes silenciosos, texturas táteis e uma paleta que deixa a luz fazer parte do desenho.</p>
          </div>
